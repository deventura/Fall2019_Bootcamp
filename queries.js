...
var removeCable = function() {
   ...
   */
   ...
   Listing.findOneAndRemove({code: "CABL"}, function (err, doc){
     console.log('removed document with the code CABL');
   });
...
var updatePhelpsMemorial = function() {
   ...
   */
   Listing.findOneAndUpdate({code: "PHL", name: "Phelps Laboratory"}, {address: "1953 Museum Rd, Gainesville, FL 32603"}, function(err, doc){
     console.log(doc);
   });
};
